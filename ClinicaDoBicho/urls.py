...
from api.auth import MyTokenObtainPairView, MyTokenRefreshView, LogoutView
from api.views import ClienteViewSet, AnimalViewSet, ConsultaViewSet, MedicoVeterinarioViewSet
