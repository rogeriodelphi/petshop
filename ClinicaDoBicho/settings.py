...
SECRET_KEY = 'django-insecure-c@mmaf2#qufzb)o2(-+hw_^!!imz94j9%0uej)nl=8um%1m+z#'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        # 'rest_framework.authentication.SessionAuthentication', # pode da problema com token do jwt remover
